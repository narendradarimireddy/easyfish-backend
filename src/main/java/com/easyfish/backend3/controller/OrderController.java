...
public class OrderController {
    ...
    public Order cancelOrder(@PathVariable Long orderId, @RequestBody(required = false) Map<String, String> body) {
        return service.cancelOrder(orderId, body == null ? "Cancelled by user" : body.getOrDefault("reason", "Cancelled by user"));
    }
}
