...
public class ProductController {
    ...
    // Production direct upload flow: frontend asks backend for a signed Cloudflare R2 PUT URL,
    // uploads compressed image directly to R2, and stores only publicUrl in PostgreSQL.
