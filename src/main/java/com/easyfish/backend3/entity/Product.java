...
public class Product {
	...
	public Double getLowStockLimit() { return lowStockLimit; }
	public void setLowStockLimit(Double lowStockLimit) { this.lowStockLimit = lowStockLimit; }
    ...
    // Product visibility/type metadata. Stock master products stay hidden from store;
    // published variants are visible when price, pack size and stock are valid.
